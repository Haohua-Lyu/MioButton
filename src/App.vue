  ...
  <div id="app">
        ...
        <footer class="footer">
            <div class="container-fluid footer-content">
                <button class="btn-buttom btn-buttom-info"><a href="javascript:location.reload();" target="_blank" style="color: #eeeeee;text-decoration: none">Version 2.7.6</a></button>
                <div class="pull-left">
