    ...
    <div class="container-fluid" >
        <div>
            ...
            <div class="cate-body">
                ...
                <button class="btn btn-info" :class="{ 'disabled': autoCheck }" @click="overlap" :title="$t('info.overlapTips') class="{ 'disabled': stopPlay }" @click="overlap" :title="$t('info.overlapTips')">
