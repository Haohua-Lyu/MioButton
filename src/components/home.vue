...
class HomePage extends Vue {
    ...
    randomshare() {
        ...
        if(this.$i18n.locale === 'ja-JP'){
            window.open("https://twitter.com/intent/tweet?text="+"今日、「"+res+"」のランダムオーディオは「"+title+"」です！ より多くのオーディオを聞くには、「ミオボタン」のWebサイトにアクセスしてください~ #ミオボタン #ミオかわいい https://t.co/TLdj8E9Rct");
        } else {
            window.open("https://twitter.com/intent/tweet?text="+"今天，“"+res+"”的随机音频是“"+title+"”！ 访问狼按钮网站聆听更多音频 #ミオボタン #ミオかわいい https://t.co/TLdj8E9Rct");
        }
    }
    autoPlay(){
        if (this.overlapCheck) {
